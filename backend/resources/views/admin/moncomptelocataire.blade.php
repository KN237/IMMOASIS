...
@push('page-css')
	...
	<style>
        .kbw-signature { width: 1904px; height: 200px;}
    </style>
							...
							<div class="row form-row">
								...
								<div class="col-12">
									<div class="form-group">
										...
										<input class="form-control" name="nomcomplet" type="text" value="{{ $data->nomcomplet }}">
									</div>
								</div>
								...
								<div class="col-12">
									<div class="form-group">
										...
										<input class="form-control" name="telephone" type="text" value="{{ $data->telephone }}">
									</div>
								</div>
								...
								<div class="col-12">
									...
									<div class="col-12">
										<div class="form-group">
											...
											<input class="form-control" name="quartier" type="text" value="{{ $l->quartier }}">
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group">
											...
											<input class="form-control" name="profession" type="text" value="{{ $l->profession }}">
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group">
											...
											<input class="form-control" name="nomemployeur" type="text" value="{{ $l->nomemployeur }}">
										</div>
									</div>
									...
									<div class="col-12">
										<div class="form-group">
											<label>Telephone employeur</label>
											<input class="form-control" name="telemployeur" type="text" value="{{ $l->telemployeur }}">
										</div>
									</div>
				...
				<div class="card ">
					<div class="card-body">
						...
						<div class="row">
							...
							<form method="POST" action="/locataire/sign/{{$l->idlocataire}}" class="d-flex" style="flex-direction: column;">
								@csrf
			
									<div id="sig" ></div>
									<textarea id="signature64" name="signed" style="display: none"></textarea>

						<center style="transform: translateX(30%)"><div><button class="btn btn-secondary btn-lg m-5 w-25">Enregistrer</button> <button id="clear" class="btn btn-danger btn-lg m-5 w-25">Effacer</button>
						</div></center>
							</form>
						...
						<img style="transform: translateX(10%)" src="/storage/signatures/{{$l->signature}}" alt="{{ $l->signature || "Pas encore de signature "}}" width="800" class="ml-5">
