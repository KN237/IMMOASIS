					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body">
                                ...
                                <div class="row">
									<p class="col-sm-2 text-muted text-sm-right mv-0 mb-sm-3">Téléphone du représentant</p>
								...
								<div class="row form-row">
                                    ...
                                    <div class="col-12">
										<div class="form-group">
											...
											<input class="form-control" name="nomrep" type="text" value="{{ $l->nomrep }}">
										</div>
									</div>
                                    ...
                                    <div class="col-12">
										<div class="form-group">
											...
											<input class="form-control" name="telrep" type="text" value="{{ $l->telrep }}">
										</div>
									</div>
				...
				<div class="card ">
					<div class="card-body">
						...
						<div class="row">
							...
							<form method="POST" action="/bailleur/sign/{{$l->idbailleur}}" class="d-flex" style="flex-direction: column;">
								@csrf
