...
<center class="mt-2"><h4> Voulez-vous vraiment vous supprimer ce type de location de votre liste?</h4></center>

<center class="mt-5 mb-4"><button onclick="event.preventDefault; var form=document.getElementById('form2{{ $l->idtl}}'); form.submit();"
